  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Portal for querying and downloading tax certificates, with map integration and online document management.',
        stack: ['PHP', 'MySQL', 'JavaScript'],
        type: 'Omega Soluciones Web',
        link: null,
      },
      {
        ...
        description: 'Affiliate portal with authentication, account management, and control panel for business partners.',
      ...
      },
      {
        ...
        description: 'B2B platform for commercial relationship management with authentication and enterprise control panel.',
      ...
      },
      {
        ...
        description: 'Marketplace for entrepreneurs with product catalog, cart, and independent seller management.',
        stack: ['PHP', 'MySQL', 'JavaScript'],
        type: 'Omega Soluciones Web',
        link: null,
      },
      {
        ...
        description: 'Certificate management and issuance system with user authentication and document download.',
      ...
      },
      {
        ...
        description: 'Self-service kiosk system for orders and services in recreational and sports facilities.',
        stack: ['PHP', 'MySQL', 'JavaScript'],
        type: 'Omega Soluciones Web',
        link: null,
      },
      {
        ...
        description: 'Home delivery services platform with product catalog and online ordering system.',
      ...
      },
      {
        ...
        description: 'Cultural venue website with events calendar, reservations system, and editorial blog.',
      ...
      },
      {
        ...
        description: 'Member data update system with validated forms and profile management.',
        stack: ['PHP', 'MySQL', 'JavaScript'],
        type: 'Omega Soluciones Web',
        link: null,
      },
      {
        ...
        description: 'Financial services portal with PSE payment gateway integration, maps, and WhatsApp communication.',
        stack: ['PHP', 'JavaScript', 'Bootstrap'],
        type: 'Omega Soluciones Web',
        link: null,
      },
      {
        ...
        description: 'Industry association website with member directory, news, events, and multimedia gallery.',
        stack: ['PHP', 'JavaScript', 'Bootstrap'],
        type: 'Omega Soluciones Web',
        link: null,
      },
      {
        ...
        description: 'Institutional portal for non-profit organization with member directory, news, and content management.',
        stack: ['PHP', 'JavaScript', 'Bootstrap'],
        type: 'Omega Soluciones Web',
        link: null,
      },
      {
        ...
        description: 'Sports prediction system with user registration, real-time forecasts, and leaderboard.',
        stack: ['PHP', 'MySQL', 'JavaScript'],
        type: 'Omega Soluciones Web',
        link: null,
      },
